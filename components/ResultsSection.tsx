  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
        ...
        <motion.div
          whileHover={{ y: -4 }}
          className="flex flex-col rounded-2xl border border-red-500/20 bg-slate-900/60 backdrop-blur-md overflow-hidden relative"
        >
          {/* Top Red Glow Accent */}
          ...
          <div className="p-6 flex-1 flex flex-col">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-4 mb-4">
              ...
              <button
                ...
                className="p-2 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 transition-colors flex items-center gap-1.5 text-xs border border-slate-700"
                title="نسخ الترويق"
              >
        ...
        <motion.div
          whileHover={{ y: -4 }}
          className="flex flex-col rounded-2xl border border-emerald-500/20 bg-slate-900/60 backdrop-blur-md overflow-hidden relative"
        >
          ...
          <div className="p-6 flex-1 flex flex-col">
            ...
            {/* Fix Body */}
            <div className="flex-1 text-slate-200 text-sm md:text-base leading-relaxed whitespace-pre-line text-left">
              {fix}
            </div>
          </div>
        </motion.div>
      ...
      <div className="flex justify-center pt-4">
        <button
          onClick={onReset}
          className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-slate-950 font-bold rounded-xl shadow-lg transition-all duration-200 transform hover:scale-105 active:scale-95"
        >
          <RotateCcw size={18} />
